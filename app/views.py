...
def get_data(theme):
    ...
    url = "https://www.googleapis.com/youtube/v3/search?maxResults=10&q={}&type=video&key=AIzaSyD8OlFQvf8f6dXuYRSCekWHy9x9gTJjDyU".format(theme+" songs in "+song_language)
